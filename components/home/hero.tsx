...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-border bg-gradient-to-br from-secondary via-background to-accent/60 py-16 sm:py-24">
      <div className="pointer-events-none absolute inset-0 bg-[url('/images/cleaning-hero-accent.png')] bg-cover bg-center opacity-25" />
      <div className="pointer-events-none absolute -left-24 top-10 h-72 w-72 rounded-full bg-chart-4/25 blur-3xl" />
