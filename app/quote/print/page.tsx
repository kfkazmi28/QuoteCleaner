    ...
    <>
      ...
      >
        ...
        <p style={{ color: "#9ca3af", fontSize: "11px", textAlign: "center", margin: 0 }}>
          Generated by <span contentEditable suppressContentEditableWarning className="editable">{generatedBy || "CleanQuote Pro"}</span> &middot; Prices are estimates and may vary based on final home inspection.
        </p>
      </div>
    </>
  )
